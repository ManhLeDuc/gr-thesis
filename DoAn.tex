...
\newpage
\pagenumbering{gobble}
% \title{DANH MỤC THUẬT NGỮ VÀ TỪ VIẾT TẮT}
% \renewcommand\bibname{TỪ VIẾT TẮT}
% \phantomsection\addcontentsline{toc}{chapter}{TỪ VIẾT TẮT}
\subfile{Chuong/0_5_Danh_muc_viet_tat.tex}

\newpage
\pagenumbering{gobble}
% \renewcommand\bibname{THUẬT NGỮ}
% \phantomsection\addcontentsline{toc}{chapter}{THUẬT NGỮ}
